...
const String _privacyPolicy = '''Digda(이하 "회사")는 이용자의 개인정보를 소중히 여기며, 「개인정보 보호법」 및 「정보통신망 이용촉진 및 정보보호 등에 관한 법률」을 준수합니다.
...
· 이메일 문의: privacy@digda.app (접수 후 7영업일 이내 처리)
...
회원 가입 시 만 14세 이상임을 확인하는 절차를 거치며, 만 14세 미만으로 확인된 경우 즉시 가입이 제한되고 수집된 정보는 파기됩니다.
