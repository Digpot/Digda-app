...
// 한강하구(DMZ 서단)→황해남도 남해안 서진→서해안 북상→압록강 국경 동북진→
// 백두산→두만강→동북단(라선)→동해안 남서진→원산만→DMZ 동단.
const NK_COAST = [
  [126.45, 37.80], [126.20, 37.73], [125.95, 37.80], [125.70, 37.72],
  [125.45, 37.80], [125.10, 37.67], [124.88, 37.78], [124.65, 38.10],
  [124.88, 38.30], [125.10, 38.35], [125.35, 38.60], [125.37, 38.72],
  [125.18, 38.90], [125.30, 39.20], [125.38, 39.45], [125.60, 39.55],
  [125.25, 39.62], [124.95, 39.70], [124.63, 39.80], [124.38, 40.02],
  // 압록강 국경
  [124.75, 40.28], [125.05, 40.45], [125.40, 40.62], [125.65, 40.80],
  [125.95, 40.85], [126.20, 41.05], [126.55, 41.35], [126.85, 41.70],
  [127.20, 41.50], [127.60, 41.45], [127.95, 41.43], [128.10, 41.70],
  [128.05, 42.00],
  // 두만강 국경 → 동북단
  [128.45, 42.02], [128.95, 42.00], [129.35, 42.25], [129.75, 42.45],
  [129.95, 42.75], [130.35, 42.95], [130.65, 42.42], [130.68, 42.30],
  // 동해안 남서진
  [130.35, 42.20], [129.95, 41.90], [129.70, 41.55], [129.45, 41.20],
  [129.15, 40.85], [128.75, 40.55], [128.15, 40.00], [127.85, 39.85],
  [127.55, 39.70], [127.42, 39.40], [127.40, 39.18], [127.70, 39.00],
  [128.00, 38.85], [128.25, 38.70], [128.37, 38.62],
];
...
const [xWest] = project(NK_COAST[0][0], NK_COAST[0][1]);
